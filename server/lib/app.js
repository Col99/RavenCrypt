...
//either we accept raw data which might proof to be a lot more useful later!
...
//..or we could use the express body parser:
//app.use(express.bodyParser())
//i like to handle the parsing this way, so we have the rawbody at our disposal if we need it
//function bodyParser(req, res, next){
//    try {
//        req.body = JSON.parse(req.rawBody);
//    } catch(err) {
//        //we don't have to handle errors here, functions should check for body properties themselves and will notice the missing body.
//    }
//    next();
//}
//app.use(bodyParser);
...
//
//        } catch(err){
//            global.logger.warn("InvalidSession: " + JSON.stringify(err));
